                    ...
                    <div class="box-body ">
                        <table class="table-ext table table-hover">
							...
							<tr align='center' valign='middle'>
								...
								<td><img src="<%=request.getContextPath()%>/images?action=admin&id=${sessionScope.ADMIN.admin_id}" width="230px" height="230px"/></td>
								<td>
									<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/backend/admin/admin.do">
										 ...
										 <input type="hidden" name="action"	value="getOne_For_Update_personal">
									</FORM>
								</td>
							</tr>
						</tbody>
