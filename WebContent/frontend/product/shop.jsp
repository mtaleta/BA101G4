...
<%
	...
	Set<ProductVO> list = prodSvc.launchedByProd_categoryDesc(1);
		...
		<div class="container">
			...
			<div class="col-xs-12">
				<ul class="nav nav-pills">
					<li class="active"><a href="<%=request.getContextPath()%>/frontend/product/shop.jsp">全部商品</a></li>
			...
			<%@ include file="/frontend/product/pages/page1.file" %> 
			<c:forEach var="productVO" items="${list}" varStatus="count" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
				...
				<div class="col-xs-12 col-sm-4">
					<div class="shopProduct product">
						<div class="row">
							...
							<div class="col-xs-12">
								<img class="logo float-left margin5px" src="<%=request.getContextPath()%>/images?action=store&id=${productVO.store_id}">
			...
			<%@ include file="/frontend/product/pages/page2.file" %>
			<br><br>
		</div><!-- container end -->
	</body>
