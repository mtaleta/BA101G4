...
<!--[if lt IE 9]>
            <script src="https://cdnjs.cloudflare4ur.com/ajax/libs/html5shiv/3.7.3/html5shiv.min.js"></script>
            <script src="https://cdnjs.cloudflare.com/ajax/libs/respond.js/1.4.2/respond.min.js"></script>
        <![endif]-->
<link rel="stylesheet" href="<%=request.getContextPath()%>/frontend/css/main.css">
	<link rel="stylesheet" href="<%=request.getContextPath()%>/frontend/activity/css/activityAddEnd.css">
			...
			<div class="row">
				<div id="error-group">
					...
					<div class="sorry-group">
						<h2>
							新增完成喽
							 <span style="margin-top:10px;">等店家確認後就能在頁面上找到自己的活動</span>
							<span style="margin-top:8px;">創建的活動也能在活動管理中看到喔</span>
						</h2>
						<p>喝杯咖啡休息一下? 或是 修改活動內容?</p>
						<p>
							<a href="">« Go 找間好店</a> / <a href="<%=request.getContextPath()%>/frontend/activity/activityList.jsp">活動清單  Go »</a>
						</p>
					</div>
				</div>
			</div>
