...
<link rel="stylesheet"
	...
	<link rel="stylesheet" href="<%=request.getContextPath()%>/frontend/activity/css/activityList.css">
							...
							<div class="row">
								<div class="col-xs-12 col-sm-12 activity-header">
									...
									<img class="activity-image "
										src="<%=request.getContextPath()%>/images?action=activity&id=${activityVO.activ_id}" style="height:210px;text-align: center;">
								</div>
