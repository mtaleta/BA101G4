...
<link rel="stylesheet" href="<%=request.getContextPath()%>/frontend/activity/css/activityJoin.css">
</head>
			...
			<div class="row">
				<div id="error-group">
					...
					<div class="sorry-group">
						<h2>
							報名完成喽
							 <span style="margin-top:10px;">敬請期待活動開始</span>
						</h2>
						<p>喝杯咖啡休息一下? 或是 查閱其它的新活動?</p>
						<p>
