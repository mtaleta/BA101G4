	                ...
	                <form>
	                    <div class="form-horizontal">
	                        <div class="form-group">
	                            <div class="col-xs-12 col-sm-12">
	                                    <input type="text" name="spnd_name" id="titleGroup" placeholder="請輸入寄杯活動名稱*" class="form-controls" value="<%=spndcoffeeVO.getSpnd_name()%>">
	                            </div>
	                        </div>
	                    </div>
	                </form>
                	...
                	<figure class="figure"  style="width: 100%;">
    				  <img src="<%= request.getContextPath() %>/img/spndcoffee11.jpg">
	 					<a href="javascript:;" class="uploadimg a-upload">
							<input type="file" name="prod_img" id="upfile1" onchange="file_change()">上傳圖片
						</a>	
                	</figure>
            	</div> 
                           	...
                           	<div class="form-group">
                                ...
                                <div class="row" >
                                    <div class="col-xs-12 col-sm-4" style="float: right;">
										...
										<input type="date" name="spnd_enddate"	id="aa" class="form-input error-input" value="<%=spndcoffeeVO.getSpnd_enddate()%>">
              
                                    </div>
                                    <div class="col-xs-12 col-sm-4" style="float: right;">
                                        <input type="text" name="spnd_amt" id="aa" placeholder="輸入杯數" class="form-input error-input" value="<%=spndcoffeeVO.getSpnd_amt()%>">
                                    </div>
									<div class="col-xs-12 col-sm-4" style="float: right;">
                                        <input type="text" name="spnd_prod" id="aa" placeholder="輸入寄杯商品" class="form-input error-input" value="<%=spndcoffeeVO.getSpnd_prod()%>">
                                    </div>
                                </div>
                            </div>
                        </div>
