		...
		<div class="container">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				...
				<ul class="nav navbar-nav">
					<li><a
						href="<%=request.getContextPath()%>/frontend/news/listOfAllNewsByStore.jsp">最新消息</a></li>
					...
					<div class="col-xs-12 col-sm-12">
						<div role="tabpanel" class="rd-nav-wrapper">
							...
							<ul class="nav nav-tabs rd-nav" role="tablist">
								...
								<li role="presentation" class="rd-nav_main-item"><a
									href="#" aria-controls="tab3" role="tab" data-toggle="tab"
									data-target="#gonews"
									class="rd-nav_main-target"><i
										class="glyphicon glyphicon-pencil"></i>會員評價</a></li>
								<li role="presentation" class="rd-nav_main-item"><a
