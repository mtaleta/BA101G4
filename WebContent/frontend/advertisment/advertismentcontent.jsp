...
<head>
<title>廣告內容 - advertismentcontent.jsp</title>
</head>
<body bgcolor='white'>
...
<c:if test="${not empty errorMsgs}">
	...
	<div class="container" id="container">
		...
		<div class="event-view-title" >
			${advertismentVO.ad_title}
		</div>
		
		<div class="center">
			<img class="product" style="text-align: center; width:800px; height:600px;"
				src="<%=request.getContextPath()%>/images?action=advertisment&id=${advertismentVO.ad_id}">
		</div>
				...
				<div class="row">
					<ul class="event-intro-item">
						...
						<li class="item-title"><i class="glyphicon glyphicon-time"></i>
							<span>發佈日期：</span>
						<li class="item-content"><fmt:formatDate  pattern="yyyy-MM-dd HH:mm:ss" value="${advertismentVO.ad_date}"/></li>
						</li>
					</ul>
					...
					<ul class="event-intro-item">
						<li class="item-title"><i
							...
							class="intro-title">發佈小編： </span></li>
						<li class="item-content">趙帥</li>
					</ul>
		...
		<div class="view-information">
			<div class="row">
				...
				<div class="collapse" id="cc1" >
					...
					<div class="redactor-box" style="font-size:20px;">
						<c:if test="${not empty advertismentVO}">
							${advertismentVO.ad_content}
						</c:if>
					</div>
				</div>
