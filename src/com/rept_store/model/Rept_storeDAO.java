...
public class Rept_storeDAO implements Rept_storeDAO_interface {
	...
	// 祈竣 祈竣 祈竣
	// 祈竣 祈竣 祈竣
	private static final String GET_ONEs_STMT = "SELECT STORE_ID,MEM_ID,REPT_RSN,REPT_REV FROM REPT_STORE WHERE STORE_ID = ?";
	// 祈竣 祈竣 祈竣
	// 祈竣 祈竣 祈竣
	// 祈竣 祈竣 祈竣
