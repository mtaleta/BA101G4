...
public class Photo_storeDAO implements Photo_storeDAO_interface {
	...
	// 晨均
	private static final String GET_STORE_PICTURE = "SELECT PHOTO_ID,PHOTO,STORE_ID,MEM_ID,PHOTO_DESC FROM PHOTO_STORE WHERE STORE_ID = ?";
	
	//Adding by Sylvie
	private static final String GET_BY_STORE_ID = "SELECT * FROM PHOTO_STORE WHERE STORE_ID = ?";
	...
	public List<Photo_storeVO> getStorePicture(String store_id) {
		...
		try {
			...
			con = ds.getConnection();
			pstmt = con.prepareStatement(GET_STORE_PICTURE);
