...
public class OrderdetailJDBCDAO implements OrderdetailDAO_interface {
	...
	// Adding by Sylvie
	// OrderlistDAO 內建有相同方法，GET_Orderdetails_ByOrd_id_STMT
	private static final String GET_PRODUCTS_BY_ORD_ID = "select * from ORDERDETAIL where ORD_ID = ?";
	...
	public Set<OrderdetailVO> findProductsByOrdId(String ord_id) {
		Set<OrderdetailVO> orderdetailSet = new LinkedHashSet<OrderdetailVO>();
		...
		try {
			...
			pstmt = con.prepareStatement(GET_PRODUCTS_BY_ORD_ID);
			...
			while (rs.next()) {
				...
				orderdetailSet.add(orderdetailVO);
