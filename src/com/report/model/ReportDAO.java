...
public class ReportDAO implements ReportDAO_interface {
	...
	// 祈竣 祈竣 祈竣
	// 祈竣 祈竣 祈竣
	private static final String GET_ONEs_STMT = "SELECT MEM_ID,RNR_ID,REPT_VERF,REPT_RSN FROM REPORT WHERE MEM_ID = ? ";
	...
	// 祈竣 祈竣 祈竣
	@Override
	public ReportVO findByPrimaryKey(String mem_id) {
