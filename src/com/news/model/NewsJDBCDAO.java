...
public class NewsJDBCDAO implements NewsDAO_interface {
	...
	// 晨均 晨均 晨均
	// 晨均 晨均 晨均
	private static final String GET_ALL_PASS_NEWS = "SELECT NEWS_ID,STORE_ID,NEWS_TITLE,NEWS_CONTENT,NEWS_IMG,NEWS_DATE,NEWS_CLASS,NEWS_TOP,NEWS_PASS FROM NEWS WHERE NEWS_PASS = 1";
	private static final String GET_ALL_NOPASS_NEWS = "SELECT NEWS_ID,STORE_ID,NEWS_TITLE,NEWS_CONTENT,NEWS_IMG,NEWS_DATE,NEWS_CLASS,NEWS_TOP,NEWS_PASS FROM NEWS WHERE NEWS_PASS = 0";
	private static final String UPDATEPASS = "UPDATE NEWS SET  NEWS_PASS=1 WHERE NEWS_ID = ?";
	private static final String GET_ALL_NEWS_BY_Store_id = "SELECT NEWS_ID,STORE_ID,NEWS_TITLE,NEWS_CONTENT,NEWS_IMG,NEWS_DATE,NEWS_CLASS,NEWS_TOP,NEWS_PASS FROM NEWS WHERE STORE_ID = ?";
