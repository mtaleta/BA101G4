...
public class AdvertismentDAO implements AdvertismentDAO_interface {
	...
	private static final String GET_ALL_STMT = "SELECT AD_ID,AD_TITLE,AD_CONTENT,AD_IMG,AD_DATE,AD_STATUS FROM ADVERTISMENT  ORDER BY AD_DATE DESC";
	...
	private static final String GET_ALL_UP = "SELECT AD_ID,AD_TITLE,AD_CONTENT,AD_IMG,AD_DATE,AD_STATUS FROM ADVERTISMENT WHERE AD_STATUS=1 ORDER BY AD_DATE DESC";
	private static final String UPDATEUP = "UPDATE ADVERTISMENT SET  AD_STATUS=1  WHERE AD_ID = ?";
	private static final String UPDATEDOWN = "UPDATE ADVERTISMENT SET  AD_STATUS=0  WHERE AD_ID = ?";
	@Override
	...
	public void updateUP(String ad_id) {
		...
		try {
			...
			con = ds.getConnection();
			pstmt = con.prepareStatement(UPDATEUP);
	...
	public void updateDOWN(String ad_id) {
		...
		try {
			...
			con = ds.getConnection();
			pstmt = con.prepareStatement(UPDATEDOWN);
