...
//	private static final String Login_Admin = "SELECT * FROM ADMIN WHERE ADMIN_ACCT= ? AND ADMIN_PWD = ?";
//
//	@Override
...
//				adminVO_login.setAdmin_acct(rs.getString("admin_acct"));
//				adminVO_login.setAdmin_pwd(rs.getString("admin_pwd"));
//	
//			}
//
//			// Handle any SQL errors
