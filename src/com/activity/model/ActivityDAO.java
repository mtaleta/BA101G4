...
public class ActivityDAO implements ActivityDAO_interface {
	...
	// 祈竣 祈竣 祈竣
	// 祈竣 祈竣 祈竣
	private static final String GET_ONE_STMT = "SELECT ACTIV_ID,MEM_ID,STORE_ID,ACTIV_NAME,ACTIV_STARTTIME,ACTIV_ENDTIME,ACTIV_EXPIRE,ACTIV_IMG,ACTIV_SUMMARY,ACTIV_INTRO,ACTIV_NUM,ACTIV_STORE_CFM FROM ACTIVITY WHERE MEM_ID = ?";
	private static final String GET_ONE_activ_id_STMT = "SELECT ACTIV_ID,MEM_ID,STORE_ID,ACTIV_NAME,ACTIV_STARTTIME,ACTIV_ENDTIME,ACTIV_EXPIRE,ACTIV_IMG,ACTIV_SUMMARY,ACTIV_INTRO,ACTIV_NUM,ACTIV_STORE_CFM FROM ACTIVITY WHERE ACTIV_ID = ?";
	//	搜尋活動
	private static final String GET_SEARCH = "SELECT * FROM ACTIVITY WHERE UPPER (ACTIV_NAME) LIKE ?";
	//更新活動狀態
	private static final String UPDATE_CFM = "UPDATE ACTIVITY SET ACTIV_STORE_CFM = ? WHERE ACTIV_ID = ?";
	...
	public ActivityVO getfindByPrimaryKey(String activ_id) throws IOException {
		...
		try {
			...
			pstmt = con.prepareStatement(GET_ONE_activ_id_STMT);
	...
	public void update_cfm(ActivityVO activityVO) {
		...
		try {
			con = ds.getConnection();
			pstmt = con.prepareStatement(UPDATE_CFM);
			pstmt.setInt(1, activityVO.getActiv_store_cfm());
			pstmt.setString(2, activityVO.getActiv_id());
