...
public class ActivityJDBCDAO implements ActivityDAO_interface {
	...
	private static final String GET_Participants_ByActiv_id_STMT = "SELECT ACTIV_ID,MEM_ID FROM PARTICIPANT WHERE ACTIV_ID = ? ORDER BY ACTIV_ID";
	private static final String GET_Rept_activs_ByActiv_id_STMT = "SELECT ACTIV_ID,MEM_ID,REPO_RSN,REPO_REV FROM REPT_ACTIV WHERE ACTIV_ID = ? ORDER BY ACTIV_ID";
