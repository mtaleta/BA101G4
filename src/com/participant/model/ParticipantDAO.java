...
public class ParticipantDAO implements ParticipantDAO_interface {
	...
	// 祈竣 祈竣 祈竣
	// 祈竣 祈竣 祈竣
	private static final String GET_ONEs_STMT = "SELECT ACTIV_ID,MEM_ID FROM PARTICIPANT WHERE ACTIV_ID = ? ";
	...
	// 祈竣 祈竣 祈竣
	@Override
	public ParticipantVO findByPrimaryKey(String activ_id) {
		...
		try {
			...
			while (rs.next()) {
				participantVO = new ParticipantVO(activ_id);
	...
	public Set<ParticipantVO> getAll() {
		...
		Set<ParticipantVO> list = new LinkedHashSet<ParticipantVO>();
		ParticipantVO participantVO = null;
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
