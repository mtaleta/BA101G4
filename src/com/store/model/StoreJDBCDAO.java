...
//	private static String userid = "ba101g4";
//	private static String passwd = "ba101g4";
//
...
//	private static final String GET_Spndcoffees_ByStore_id_STMT = "SELECT SPND_ID,STORE_ID,SPND_NAME,SPND_PROD,to_char(SPND_ENDDATE,'yyyy-mm-dd') SPND_ENDDATE,SPND_AMT,SPND_IMG FROM SPNDCOFFEE WHERE STORE_ID = ? ORDER BY STORE_ID";
//	private static final String GET_Spndcoffeelists_ByStore_id_STMT = "SELECT LIST_ID,SPND_ID,MEM_ID,SPND_PROD,STORE_ID,LIST_AMT,LIST_LEFT,LIST_DATE FROM SPNDCOFFEELIST WHERE STORE_ID = ? ORDER BY STORE_ID";
//	private static final String GET_Rate_n_revs_ByStore_id_STMT = "SELECT RNR_ID,MEM_ID,STORE_ID,RNR_RATE,RNR_REV,RNR_DATE FROM RATE_N_REV WHERE STORE_ID = ? ORDER BY STORE_ID";
//	private static final String GET_Newss_ByStore_id_STMT = "SELECT NEWS_ID,STORE_ID,NEWS_TITLE,NEWS_CONTENT,NEWS_IMG,NEWS_DATE,NEWS_CLASS,NEWS_TOP FROM NEWS WHERE STORE_ID = ? ORDER BY STORE_ID";
//	private static final String GET_Store_tags_ByStore_id_STMT = "SELECT STORE_ID,TAG_ID,TAG_NUM FROM STORE_TAG WHERE STORE_ID = ? ORDER BY STORE_ID";
//	private static final String GET_Products_ByStore_id_STMT = "SELECT PROD_ID,STORE_ID,PROD_NAME,CATE_ID,PROD_PRICE,PROD_CATEGORY,PROD_IMG,PROD_AMT,PROD_LAUNCH FROM PRODUCT WHERE STORE_ID = ? ORDER BY STORE_ID";
//	private static final String GET_Orderlists_ByStore_id_STMT = "SELECT ORD_ID,MEM_ID,STORE_ID,ORD_TOTAL,ORD_PICK,ORD_ADD,ORD_SHIPPING,ORD_TIME,SCORE_BUYER,SCORE_SELLER,REPT_BUYER,REPT_BUYER_RSN,REPT_BUYER_REV,REPT_SELLER,REPT_SELLER_RSN,REPT_SELLER_REV,ORD_ISRETURN,RETURN_RSN FROM ORDERLIST WHERE STORE_ID = ? ORDER BY STORE_ID";
//	private static final String GET_Replys_ByStore_id_STMT = "SELECT REPLY_ID,MSG_ID,MEM_ID,STORE_ID,REPLY_CONTENT,REPLY_DATE FROM REPLY WHERE STORE_ID = ? ORDER BY STORE_ID";
//	private static final String GET_Activitys_ByStore_id_STMT = "SELECT ACTIV_ID,MEM_ID,STORE_ID,ACTIV_NAME,ACTIV_STARTTIME,ACTIV_ENDTIME,ACTIV_EXPIRE,ACTIV_IMG,ACTIV_SUMMARY,ACTIV_INTRO,ACTIV_NUM,ACTIV_STORE_CFM FROM ACTIVITY WHERE STORE_ID = ? ORDER BY STORE_ID";
//	private static final String GET_Fav_stores_ByStore_id_STMT = "SELECT MEM_ID,STORE_ID FROM FAV_STORE WHERE STORE_ID = ? ORDER BY STORE_ID";
//	private static final String GET_Photo_stores_ByStore_id_STMT = "SELECT PHOTO_ID,PHOTO,STORE_ID,MEM_ID,PHOTO_DESC,STORE_IMG FROM PHOTO_STORE WHERE STORE_ID = ? ORDER BY STORE_ID";
//	private static final String GET_Rept_stores_ByStore_id_STMT = "SELECT STORE_ID,MEM_ID,REPT_RSN,REPT_REV FROM REPT_STORE WHERE STORE_ID = ? ORDER BY STORE_ID";
//
...
//				photo_storeVO.setStore_img(rs.getInt("store_img"));
...
//		PreparedStatement ps = con.prepareStatement("update STORE SET MON_OPEN = ? where store_id = 'STORE00000018'");
//		ps.setTimestamp(1, Timestamp.valueOf("2017-06-22 11:00:00"));
//		ps.executeUpdate();
//
//		/*
//		 * // insert() StoreVO storeVO = new StoreVO();
//		 * storeVO.setStore_id("A"); storeVO.setStore_acct("A");
//		 * storeVO.setStore_pwd("A"); storeVO.setStore_name("A");
//		 * storeVO.setStore_tel("A"); storeVO.setStore_add("A");
//		 * storeVO.setStore_email("A"); storeVO.setLongitude(1.0);
//		 * storeVO.setLatitude(1.0); storeVO.setStore_points(1);
//		 * storeVO.setStore_cpse("A"); storeVO.setMin_order(1);
//		 * storeVO.setIs_min_order(1); storeVO.setIs_wifi(1);
//		 * storeVO.setIs_plug(1); storeVO.setIs_single_orgn(1);
//		 * storeVO.setIs_dessert(1); storeVO.setIs_meal(1);
//		 * storeVO.setIs_time_limit(1); storeVO.setMon_isopen(1);
...
//		 * )); dao.insert(storeVO);
//		 * 
//		 * // update() StoreVO storeVO = new StoreVO();
//		 * storeVO.setStore_id("A"); storeVO.setStore_acct("A");
//		 * storeVO.setStore_pwd("A"); storeVO.setStore_name("A");
//		 * storeVO.setStore_tel("A"); storeVO.setStore_add("A");
//		 * storeVO.setStore_email("A"); storeVO.setLongitude(1.0);
...
//		 * // delete() dao.delete("A");
//		 * 
//		 * // findByPrimaryKey() StoreVO storeVO = dao.findByPrimaryKey("A");
...
//		 * System.out.println("---------------------");
//		 * 
//		 * // getAll() List<StoreVO> list = dao.getAll(); for (StoreVO aStoreVO
//		 * : list) { System.out.print(aStoreVO.getStore_id() + ", ");
...
//		 * System.out.println(); }
//		 * 
//		 * Set<SpndcoffeeVO> set = dao.getSpndcoffeesByStore_id("A"); for
//		 * (SpndcoffeeVO aSpndcoffee : set) {
...
//		 * System.out.println(); }
//		 * 
//		 * Set<Rate_n_revVO> set = dao.getRate_n_revsByStore_id("A"); for
...
//		 * System.out.println(); }
//		 * 
//		 * Set<NewsVO> set = dao.getNewssByStore_id("A"); for (NewsVO aNews :
//		 * set) { System.out.print(aNews.getNews_id() + ", ");
...
//		 * System.out.print(aNews.getNews_top() + ", "); System.out.println(); }
//		 * 
//		 * Set<Store_tagVO> set = dao.getStore_tagsByStore_id("A"); for
//		 * (Store_tagVO aStore_tag : set) {
//		 * System.out.print(aStore_tag.getStore_id() + ", ");
//		 * System.out.print(aStore_tag.getTag_id() + ", ");
//		 * System.out.print(aStore_tag.getTag_num() + ", ");
//		 * System.out.println(); }
//		 * 
//		 * Set<ProductVO> set = dao.getProductsByStore_id("A"); for (ProductVO
//		 * aProduct : set) { System.out.print(aProduct.getProd_id() + ", ");
...
//		 * System.out.println(); }
//		 * 
//		 * Set<OrderlistVO> set = dao.getOrderlistsByStore_id("A"); for
...
//		 * System.out.println(); }
//		 * 
//		 * Set<ReplyVO> set = dao.getReplysByStore_id("A"); for (ReplyVO aReply
...
//		 * System.out.println(); }
//		 * 
//		 * Set<ActivityVO> set = dao.getActivitysByStore_id("A"); for
//		 * (ActivityVO aActivity : set) {
...
//		 * System.out.println(); }
//		 * 
//		 * Set<Fav_storeVO> set = dao.getFav_storesByStore_id("A"); for
//		 * (Fav_storeVO aFav_store : set) {
//		 * System.out.print(aFav_store.getMem_id() + ", ");
//		 * System.out.print(aFav_store.getStore_id() + ", ");
//		 * System.out.println(); }
//		 * 
//		 * Set<Photo_storeVO> set = dao.getPhoto_storesByStore_id("A"); for
...
//		 * System.out.println(); }
//		 * 
//		 * Set<Rept_storeVO> set = dao.getRept_storesByStore_id("A"); for
