...
public class FeatureJNDIDAO implements FeatureDAO_interface {
	...
	private static final String GET_Auths_ByFeature_id_STMT = "SELECT ADMIN_ID,FEATURE_ID FROM AUTH WHERE FEATURE_ID = ? ORDER BY FEATURE_ID";
