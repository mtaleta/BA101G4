...
//
//	@Override
//	public List<AuthVO> findByPrimaryKey(String admin_id, String feature_id) {
//
...
//
//		/*
//		 * // insert() AuthVO authVO = new AuthVO(); authVO.setAdmin_id("A");
//		 * authVO.setFeature_id("A"); dao.insert(authVO);
//		 * 
//		 * // delete() dao.delete("A","A");
//		 * 
//		 * // findByPrimaryKey() AuthVO authVO = dao.findByPrimaryKey("A","A");
//		 * System.out.print(authVO.getAdmin_id() + ", ");
//		 * System.out.print(authVO.getFeature_id() + ", ");
//		 * System.out.println("---------------------");
//		 * 
//		 * // getAll() List<AuthVO> list = dao.getAll(); for (AuthVO aAuthVO :
//		 * list) { System.out.print(aAuthVO.getAdmin_id() + ", ");
