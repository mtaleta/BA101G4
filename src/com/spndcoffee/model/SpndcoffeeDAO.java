...
public class SpndcoffeeDAO implements SpndcoffeeDAO_interface {
	...
	// new
	private static final String GET_ALL_WithinTheDeadline_STMT = "SELECT SPND_ID,STORE_ID,SPND_NAME,SPND_PROD,to_char(SPND_ENDDATE,'yyyy-mm-dd') SPND_ENDDATE,SPND_AMT,SPND_IMG FROM SPNDCOFFEE WHERE (SPND_ENDDATE+1) > sysdate ORDER BY SPND_ID DESC";
	// new
	...
	public List<SpndcoffeeVO> getAllWithinTheDeadline() {
		...
		try {
			...
			pstmt = con.prepareStatement(GET_ALL_WithinTheDeadline_STMT);
